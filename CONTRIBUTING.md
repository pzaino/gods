...
# Contributing to GoDS library

Your input is always welcome! I want to make contributing to this project as
...
Once you have pre-commit installed, fork GoDS and clone it to your
...
Your pull requests are always welcome. When you send a pull request, please:
...
on testing, see [Test Policy for GoDS](doc/test_policy.md).
...
This project uses GitHub issues to track public bugs. Report a bug by
[opening a new issue](https://github.com/pzaino/gods/issues);
it's that easy!
...
- Format rules followed are the same as the ones used by the Go community
...
information, see [Test Policy for GoDS](doc/test_policy.md).
